    ...
    Foundation.libs.dropdown = {
        ...
        events: function() {
            ...
            d(this.scope).off(".dropdown").on("click.fndtn.dropdown", "[" + this.attr_name() + "]", function(b) {
                ...
                return d(b.target).closest("[" + c.attr_name() + "]").length > 0 ? void 0 : !d(b.target).data("revealId") && e.length > 0 && (d(b.target).is("[" + c.attr_name() + "-content]") || a.contains(e.first()[0], b.target)) ? void b.stopPropagation() : void c.close.call(c, d("[" + c.attr_name() + "-content]"));
